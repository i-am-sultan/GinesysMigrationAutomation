            ...
            if assets:
                ...
                if latest_version != current_version:
                    ...
                    if response.status_code == 200:
                        ...
                        update_dir_path = os.path.join(os.getcwd())
                        print(f"update_dir_path: {update_dir_path}")

                        # Move the old version to PreviousVersions folder
                        old_version_dir = os.path.join(os.getcwd(), f"app")
                        version_log_dir = os.path.join(os.path.join(os.getcwd(), 'VersionsLog'),f"app_{current_version}")
                        ...
                        new_version_path = os.path.join(os.path.join(update_dir_path,'app'),'version.txt')
