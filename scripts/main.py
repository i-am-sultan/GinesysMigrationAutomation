            ...
            if assets:
                ...
                if latest_version != current_version:
                    ...
                    if response.status_code == 200:
                        ...
                        new_version_path = os.path.join(os.path.join(update_dir_path,'scripts'),'version.txt')
                        ...
                        print(os.getcwd)
                        icon_path = os.path.join(os.path.join(os.getcwd(),'scripts'),'icon')
                        file_path = os.path.join(os.path.join(os.getcwd(),'scripts'),'main.py')
                        #create the exe
